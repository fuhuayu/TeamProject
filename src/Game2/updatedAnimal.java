 ...
 */
public class updatedAnimal implements java.io.Serializable {
	/**
	 * 
	 */
	 ...
	 * @param imageHeight
	 */
	private updatedAnimal(int xloc, int yloc, String typeOfAnimal, int scoreEffect,
	 ...
	 */
	public updatedAnimal(int xloc, int yloc, String typeOfAnimal, int scoreEffect,
	 ...
	 * @return
	 */
	public updatedAnimal copy(){
		updatedAnimal copy = new updatedAnimal(xloc, yloc, typeOfAnimal, scoreEffect, displayDuration, visible);
	...
	public boolean overlapsWith(Object obj){
		updatedAnimal other = (updatedAnimal)(obj);
